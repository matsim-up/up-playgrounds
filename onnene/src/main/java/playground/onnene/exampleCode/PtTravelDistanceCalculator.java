 ...
 *
 */
public class PtTravelDistanceCalculator implements LinkEnterEventHandler, PersonDepartureEventHandler,
	...
	public PtTravelDistanceCalculator(Network network) {
	...
	public void handleEvent(PersonArrivalEvent event) {
		if (this.travelledDistance.containsKey(event.getPersonId())){
			...
			distanceDistribution[distanceInKm]++;
