...
import playground.onnene.gtfs.GtfsParser;
...
public class AfcTripChainer {
	...
	/**
	 * Executing the trip chaining procedure. The following inputs are required,
	 * and in the following order:
	 * <ol>
	 * 		<li> input file for daily records, typically generated by {@link AfcDataSplitter};
	 * 		<li> input file for the GTFS's <code>stops.txt</code> file;
	 * 		<li> input file for the transit {@link Network};
	 * 		<li> input file for the {@link TransitSchedule}; and
	 * 		<li> file where the chained trips (CSV) will be written to;
	 * </ol> 
	 * @param args
	 */
	...
	public void extractTripChains(String input, String output){
