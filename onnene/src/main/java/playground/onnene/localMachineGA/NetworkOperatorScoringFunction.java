...
public class NetworkOperatorScoringFunction implements VehicleEntersTrafficEventHandler, VehicleLeavesTrafficEventHandler, 
	...
	public double getOperatorScore() {
		...
		double vehicleOpTimeCost = ((totalvehTripDuration/(3600))) * 33;
		double vehicleOpDistanceCost = ((totalvehicleDistance/(1000)) * vehicleMap.size()) * 11;
//		double vehicleOpTimeCost = (totalvehTripDuration/(3600) * 33);
//		double vehicleOpDistanceCost = (totalvehicleDistance/1000 * 11);
