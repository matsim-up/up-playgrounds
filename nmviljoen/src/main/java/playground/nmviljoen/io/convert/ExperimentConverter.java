 ...
 * 
 */
package playground.nmviljoen.io.convert;
...
import playground.nmviljoen.phd.gridExamples.GridExperiment;
import playground.nmviljoen.phd.gridExamples.GridExperiment.Archetype;
...
public class ExperimentConverter {
	...
	public static void main(String[] args) {
		Header.printHeader(ExperimentConverter.class, args);
